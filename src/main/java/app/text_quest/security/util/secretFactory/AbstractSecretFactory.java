...
/**
 <h2> An abstract class {@link AbstractSecretFactory}

 <p> Intended for parsing secure pseudo-random string

 <p> Must be extended by the class intended for parsing
 a specified secret key.
 <p> Child class must have a constructor doesn't requesting
 ...
 <p> Child class must override a {@link AbstractSecretFactory#create()}.
